                            ...
                            <tr>
                                ...
                                <td>
                                    @if (Auth::user()->user_type == 'admin')
                                        <select class="status-select status-{{ $value->status }}"
                                            data-id="{{ $value->id }}">
                                            <option value="active" {{ $value->status == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ $value->status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('member_profile', $value->id) }}" target=""
                                        ...
                                        <span class="action-btn edit-btn open-modal"
                                            ...
                                            data-modal="common-modal-md" data-title="Edit Manager"
                            ...
                            <td colspan="9" class="text-center py-5">
                                <div style="text-align: center; padding: 3rem;">
                                    <i class="fas fa-users-slash"
                                        style="font-size: 4rem; color: var(--text-secondary); opacity: 0.5; margin-bottom: 1rem;"></i>
