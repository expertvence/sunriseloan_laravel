        ...
        <div class="nav">
            ...
            @if (Auth::user()->user_type == 'admin')
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#manager_reg"
                    aria-expanded="false" aria-controls="manager_reg">
                    <div class="sb-nav-link-icon"><i class="fas fa-users" style=" font-size: 20px;"></i></div>
                  Add Manager
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="manager_reg" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link ajax_link" href="#" data-url="{{ route('manager-create-form') }}">Create
                            Manager</a>
                        <a class="nav-link ajax_link" href="#" data-url="{{ route('manager-list') }}">Manager
                            list</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="income-expense" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link ajax_link" href="#" data-url="{{ route('income-expence') }}">Entry
                            Income-Expense</a>
                        <a class="nav-link ajax_link" href="#"
                            data-url="{{ route('income-expence-list') }}">Income-Expense List</a>
                    </nav>
                </div>
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#category"
                    aria-expanded="false" aria-controls="income-expense">
                    <div class="sb-nav-link-icon"><i class="fas fa-hand-holding-usd" style=" font-size: 20px;"></i>
                    </div>
                    Loan Category
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="category" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link ajax_link" href="#"
                            data-url="{{ url('show-categories-insert') }}">Create Categories</a>
                        <a class="nav-link ajax_link" href="#" data-url="{{ url('show_categories') }}">Categories
                            List</a>
                ...
                <div class="collapse" id="assets" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link ajax_link" href="#" data-url="{{ url('index') }}">Add Assets</a>
                        <a class="nav-link ajax_link" href="#" data-url="{{ route('show-assets') }}">Show
                            Assets</a>

                    </nav>
                </div>
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                    data-bs-target="#profile-edit" aria-expanded="false" aria-controls="income-expense">
                    <div class="sb-nav-link-icon"><i class="fas fa-diamond" style=" font-size: 20px;"></i></div>
                    Settings
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="profile-edit" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link ajax_link" href="#"
                            data-url="{{ url('admin-profile') }}">Settings</a>
            ...
            @elseif(Auth::user()->user_type == 'employee')
                ...
                <a class="nav-link ajax_link" href="#"
                    data-url="{{ route('member_profile', Auth::user()->member_id) }}">
                ...
                <div class="collapse" id="member_reg" aria-labelledby="headingOne"
                    data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link ajax_link" href="#"
             ...
             <div class="sb-sidenav-menu-heading">Manager</div>
                ...
                <div class="collapse" id="manager-loan-request" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link ajax_link" href="#" data-url="{{ url('loan-request') }}">Loan Request Form</a>
                        <a class="nav-link ajax_link" href="#" data-url="{{ url('loan-request-list') }}">Loan Request List</a>
                        <a class="nav-link ajax_link" href="#" data-url="{{ url('loan-commite') }}">Loan
                            Commit</a>
